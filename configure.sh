...
echo ''
echo "Now installing pip, tmux and jq..."
echo ''
...
echo ''
read -p "Do you want to use taylorb's dotfiles? y/n" -n 1 -r
echo    # (optional) move to a new line
if [[ $REPLY =~ ^[Yy]$ ]]
then
    echo ''
	echo "Now pulling down taylorb's dotfiles..."
	git clone https://github.com/taylorb-microsoft/dotfiles.git ~/.dotfiles
	echo ''
    ...
    if [[ $? -eq 0 ]]
    then
        echo "Successfully configured your environment with taylorb's dotfiles..."
    else
        echo "taylorb's dotfiles were not applied successfully..." >&2
fi
else 
	echo ''
    echo "You chose not to apply taylorb's dotfiles. You will need to configure your environment manually..."
	echo ''
